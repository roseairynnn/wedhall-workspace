                                ...
                                <tbody
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal{{ $company->id }}">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>

                                            <!-- Update Company Modal -->
                                            <div class="modal fade" id="updateModal{{ $company->id }}" tabindex="-1">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <!-- Update Company Form -->
                                                            <form class="row g-3" method="POST" action="{{ route('company.update', ['id' => $company->id]) }}"> 
                                                                @csrf
